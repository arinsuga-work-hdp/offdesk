...
@section('content_title', 'Booking Arsitek Info')

@section('toolbar')

<!-- button back -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('bookarsitek.index') }}">
...
@if ($viewModel->data->orderstatus_id == 3)
    <!-- button Reopen -->
    <!-- <li class="nav-item">
        <a class="nav-link" href="{{ route('bookarsitek.reopen', ['bookarsitek' => $viewModel->data->id]) }}">
...
<!-- button edit -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('bookarsitek.edit', ['bookarsitek' => $viewModel->data->id]) }}">
...
<li class="nav-item">
    ...
    <form id="frmData" role="form" id="frmData" method="POST" action="{{ route('bookarsitek.destroy', ['bookarsitek' => $viewModel->data->id]) }}">
        @csrf
        @method('DELETE')
    </form>
</li>
