...
@section('content')
        ...
        <div>
            ...
            <form role="form" id="frmData" method="POST" action="{{ route('bookandrawina.index.custom.post') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div style="display: flex; justify-content=center;">
                    @include('bo.bookandrawina.index-custom-fields')
                </div>
            </form>
...
@section('js')
    ...
    @include('bo.bookandrawina._script')
