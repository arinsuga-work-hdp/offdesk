...
@section('content_title', 'Booking Andrawina Info')

@section('toolbar')

<!-- button back -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('bookandrawina.index') }}">
...
@if ($viewModel->data->orderstatus_id == 3)
    <!-- button Reopen -->
    <!-- <li class="nav-item">
        <a class="nav-link" href="{{ route('bookandrawina.reopen', ['bookandrawina' => $viewModel->data->id]) }}">
...
<!-- button edit -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('bookandrawina.edit', ['bookandrawina' => $viewModel->data->id]) }}">
...
<li class="nav-item">
    ...
    <form id="frmData" role="form" id="frmData" method="POST" action="{{ route('bookandrawina.destroy', ['bookandrawina' => $viewModel->data->id]) }}">
        @csrf
        @method('DELETE')
    </form>
</li>
