...
@section('content')
        ...
        <div>
            ...
            <form role="form" id="frmData" method="POST" action="{{ route('booksupport.index.custom.post') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div style="display: flex; justify-content=center;">
                    @include('bo.booksupport.index-custom-fields')
                </div>
            </form>
        ...
        @if (isset($viewModel->data->datalist))
            <div style="margin-top: 10px;">
                @include('bo.booksupport.index-custom-datalist')
            </div>
        @endif
