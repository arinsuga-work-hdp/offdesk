...
@section('content_title', 'Booking Support Info')

@section('toolbar')

<!-- button back -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('booksupport.index') }}">
...
@if ($viewModel->data->orderstatus_id == 3)
    <!-- button Reopen -->
    <!-- <li class="nav-item">
        <a class="nav-link" href="{{ route('booksupport.reopen', ['booksupport' => $viewModel->data->id]) }}">
...
<!-- button edit -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('booksupport.edit', ['booksupport' => $viewModel->data->id]) }}">
...
<li class="nav-item">
    ...
    <form id="frmData" role="form" id="frmData" method="POST" action="{{ route('booksupport.destroy', ['booksupport' => $viewModel->data->id]) }}">
        @csrf
        @method('DELETE')
    </form>
</li>
